...
- (BOOL)connectToHost:(NSString *)host
         ...
         viaResolvedIP:(nullable NSString *)resolvedIP
          withTimeout:(NSTimeInterval)timeout
                error:(NSError **)errPtr;
...
**/
+ (nullable NSMutableArray *)lookupHost:(NSString *)host port:(uint16_t)port viaResolvedIP:(NSString *)resolvedIP error:(NSError **)errPtr;
